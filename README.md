# 단어 수집기
### 🐱 단어장 앱인 VoCat 스프레드시트 형식에 맞도록 단어 정보를 원클릭 저장합니다. 
- 단어(W)	의미(M)	발음(P)	품사(POS)	예문(E)	파생어(DER) 순으로 단어의 정보가 저장됩니다.
- 현재 네이버 영어사전을 통해서만 단어 추가가 가능합니다.
- 스프레드시트 불러오기시 '콤마(,)' 기준 분리되도록 설정해 주셔야 합니다
...
4. 스프레드시트에 그대로 붙여넣기하면 아래와 같이 정보가 붙여넣어집니다
   <img width="1967" height="392" alt="image" src="https://github.com/user-attachments/assets/4ec670d6-6295-44c9-86e9-3059aa490e44" />
   - 의미의 번호와 예문의 번호가 일치하도록 설정하여 해당 뜻을 가진 예문임을 알아볼 수 있도록 설정해 두었습니다. 
